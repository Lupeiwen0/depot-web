...
export default async function UserCouponsPage() {
  ...
  const [couponsData, membershipData, t] = await Promise.all([
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-4 py-8 md:py-12">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-semibold text-slate-900">{t("premiumMember")}</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-4 border shadow-sm">
            <p className="text-sm text-green-600">{t("stats.available")}</p>
          ...
          <div className="bg-white rounded-xl p-4 border shadow-sm">
            <p className="text-sm text-red-500">{t("stats.expired")}</p>
                ...
                >
                  <div className="flex">
                    ...
                    >
                      ...
                      <span className="text-sm opacity-90">{t("discount")}</span>
                    </div>
